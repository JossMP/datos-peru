		...
		<form class="form-horizontal" role="form" method="post" name="busqueda" id="busqueda">
			<div class="card border-info">
				...
				<div class="card-body">
					...
					<input type="number" class="form-control" name="ndni" id="ndni" placeholder="Ingrese DNI" pattern="([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]|[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9])" autofocus required>
				</div>
				<div class="card-footer text-center">
					<button type="submit" class="btn btn-success" name="btn-submit-1" data-source="reniec" id="btn-submit-1">
						<i class="fa fa-search"></i> RENIEC
					</button>
					<button type="submit" class="btn btn-info" name="btn-submit-2" data-source="jne" id="btn-submit-2">
						<i class="fa fa-search"></i> JNE
					</button>
				</div>
			</div>
		</form>
